...
<div class="row">
    ...
    <div class="col-sm-4">
        ...
        <form id="comForm" action="{{action('CatalogController@postComment', $pelicula->id)}}" method="post">
          ...
          <input class="mb-3 mt-2 w-100" type="text" name="title" placeholder="Resumen del comentario">
          <a>Valoración:</a>
          ...
          <textarea class="w-100" name="review" rows="5" cols="80" placeholder="Dinos tu opinión"></textarea>
